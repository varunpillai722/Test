# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 18:49:37 2022
...
class NeuralNetwork():
    ...
    #self.synaptic_weights3 = 2 * random.random((l3, 1)) -1
        ...
        self.synaptic_weights1 = [[0.1, 0.2], [0.2, 0.1]]
        self.synaptic_weights2 = [[0.1, 0.2], [0.2, 0.1]]
        self.synaptic_weights3 = [[0.1],[0.2]]
    ...
    def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
        for iteration in range(number_of_training_iterations):
            ...
            a2 = self.__sigmoid(
                dot(training_set_inputs, self.synaptic_weights1))
            ...
            del3 = dot(self.synaptic_weights3, del4.T) * \
                (self.__sigmoid_derivative(a3).T)
            del2 = dot(self.synaptic_weights2, del3) * \
                (self.__sigmoid_derivative(a2).T)
...
if __name__ == "__main__":
    ...
    print(neural_network.forward_pass(array([1, 0])))
